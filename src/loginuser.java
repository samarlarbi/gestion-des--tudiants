...
public class loginuser extends RoundedPanel {
    ...
    public loginuser() {
        ...
        JLabel title = new JLabel(
                "<html><h1  style='padding:15px; font-size:30px '><font color='white'><br> <br> <br>Session     Utilisateur</font></h1></html>");

        JLabel title2 = new JLabel(
                "<html><h3  style='padding:10px; font-size:20px '><font color='#73515D'> Entre le mot-de-passe </font></h3></html>");
        ...
        userButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (motdepassuser.getText().toString().equals("user") == false) {
